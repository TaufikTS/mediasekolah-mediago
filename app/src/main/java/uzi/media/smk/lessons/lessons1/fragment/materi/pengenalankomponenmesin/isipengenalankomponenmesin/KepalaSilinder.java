...
public class KepalaSilinder extends Fragment {
...
//        mExoPlayerView.getPlayer().setPlayWhenReady(true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_kepala_silinder, container, false);
    ...
    public void onResume() {
        ...
        if (mExoPlayerView == null || onpause == true) {
            ...
            MediaSource mediaSource = new ExtractorMediaSource(RawResourceDataSource.buildRawResourceUri(R.raw.kepala_silinder),
