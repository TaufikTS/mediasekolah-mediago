...
public class PorosEngkol extends Fragment {
...
//        mExoPlayerView.getPlayer().setPlayWhenReady(true);
    ...
    public void onResume() {
        ...
        if (mExoPlayerView == null || onpause == true) {
            ...
            MediaSource mediaSource = new ExtractorMediaSource(RawResourceDataSource.buildRawResourceUri(R.raw.poros_engkol),
