...
public class m2_perlakuan_khusus extends Fragment {
...
//        mExoPlayerView.getPlayer().setPlayWhenReady(true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.penerapan_2, container, false);
    ...
    public void onResume() {
        ...
        if (mExoPlayerView == null || onpause == true) {
            ...
            MediaSource mediaSource = new ExtractorMediaSource(RawResourceDataSource.buildRawResourceUri(R.raw.perlakuan_khusus),
