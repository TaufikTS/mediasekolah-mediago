...
public class PistonDanBatangPiston extends Fragment {
...
//        mExoPlayerView.getPlayer().setPlayWhenReady(true);
    ...
    public void onResume() {
        ...
        if (mExoPlayerView == null || onpause == true) {
            ...
            MediaSource mediaSource = new ExtractorMediaSource(RawResourceDataSource.buildRawResourceUri(R.raw.piston_dan_batang_piston),
