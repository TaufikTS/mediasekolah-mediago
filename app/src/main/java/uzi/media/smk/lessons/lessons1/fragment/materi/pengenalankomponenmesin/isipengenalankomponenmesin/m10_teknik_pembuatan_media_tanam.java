package uzi.media.smk.lessons.lessons1.fragment.materi.pengenalankomponenmesin.isipengenalankomponenmesin;
...
public class m10_teknik_pembuatan_media_tanam extends Fragment {
...
//        mExoPlayerView.getPlayer().setPlayWhenReady(true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_piston_dan_batang_piston, container, false);
    ...
    public void onResume() {
        ...
        if (mExoPlayerView == null || onpause == true) {
            ...
            MediaSource mediaSource = new ExtractorMediaSource(RawResourceDataSource.buildRawResourceUri(R.raw.teknik_pembuatan_media_tanam),
