...
public class m9_penyiapan_alat extends Fragment {
...
//        mExoPlayerView.getPlayer().setPlayWhenReady(true);
    ...
    public void onResume() {
        ...
        if (mExoPlayerView == null || onpause == true) {
            ...
            MediaSource mediaSource = new ExtractorMediaSource(RawResourceDataSource.buildRawResourceUri(R.raw.penyiapan_alat),
